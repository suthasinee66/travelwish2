...
{!selectedHotel && (
  ...
  >
      ...
      <div>
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-[#40364b]">
            ที่พักแนะนำสำหรับทริปนี้
          </h3>
        </div>

        <p className="mt-1 text-xs text-[#85798a]">
          คัดจากทำเลใกล้เส้นทางและข้อมูลที่พักที่มีในระบบ
        </p>
      </div>
    ...
    {recommendedHotelsLoading ? (
            ...
            return (
              <button
                ...
                className="
                  ...
                  hover:border-[#cdbbd2]
                  hover:shadow-[0_12px_28px_rgba(87,61,99,0.10)]
                "
              >
                <div className="relative h-24 overflow-hidden bg-[#f2edf3]">
                  {hotelImage ? (
                    <img
                      src={hotelImage}
                      alt={
                    ...
                    <div className="flex h-full items-center justify-center text-[#9b869f]">
                      <Hotel
                        size={26}
                        strokeWidth={1.7}
                      />
                ...
                <div className="p-3">
                  ...
                  <div className="mt-1 flex items-center gap-2 text-[11px] text-[#85798a]">
                    {Number.isFinite(
                      Number(
                        hotel.route_center_distance_km
                      )
                    ) && (
                  ...
                  {(hotel.accom_price_name ||
                    hotel.acc_low_rate ||
                    hotel.acc_high_rate) && (
                    <div className="mt-1.5 truncate text-[11px] text-[#746779]">
                      {hotel.accom_price_name ??
                        (
                          hotel.acc_low_rate &&
                          hotel.acc_high_rate
                  ...
                  <div className="mt-3 flex items-center gap-1 text-xs font-semibold text-[#6f456f]">
                    <Check
                      size={14}
                      strokeWidth={2}
                    />
      ...
      <div className="mt-4 rounded-xl bg-[#f7f2f8] px-4 py-3 text-xs text-[#746779]">
        ยังไม่พบที่พักที่มีพิกัดสำหรับจังหวัดนี้ กด “ดูทั้งหมด” เพื่อค้นหาเพิ่ม
      </div>
    )}
  </div>
)}
